...
file_in = 'cdi1010_hvst_200Oe.txt'
file_out= 'cdi1010_hvst_200Oe_processed.txt'
...
for i in range(int(ndata)):
    ...
    temperature += (temperature_temp[j+2],)
...
for i in range(nlength):
    fout.write('\r\n')
    fout.write(str('{:.1f}'.format(temperature[i])))	# Moment (emu)
    fout.write('\t')
